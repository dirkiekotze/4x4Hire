...
object Constants {
    ...
    const val DELETED_HIRE = "Deleted Hire"
    const val DELETED_EXPENSE = "Deleted Expense"
    const val DELETED_SERVICE_ITEM = "Deleted Service Item"
    const val REQUIRED = "Required"
    const val REPAIRS_OR_SERVICE = "Repairs / Service"
    const val HIRE_DETAILS = "Hire Detail"
    ...
    const val SUCCESSFULLY_ADDED_EXPENSE = "Successfully updated expense"
